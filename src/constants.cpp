...
void constants::_bind(py::module_& module)
{
    ...
    py::enum_<SDL_EventType>(module, "EventType", py::arithmetic())
        ...
        .value("WINDOWSHOWN", SDL_EVENT_WINDOW_SHOWN)
        .value("WINDOWHIDDEN", SDL_EVENT_WINDOW_HIDDEN)
        .value("WINDOWEXPOSED", SDL_EVENT_WINDOW_EXPOSED)
        .value("WINDOWMOVED", SDL_EVENT_WINDOW_MOVED)
        .value("WINDOWRESIZED", SDL_EVENT_WINDOW_RESIZED)
        .value("WINDOWMINIMIZED", SDL_EVENT_WINDOW_MINIMIZED)
        .value("WINDOWMAXIMIZED", SDL_EVENT_WINDOW_MAXIMIZED)
        .value("WINDOWRESTORED", SDL_EVENT_WINDOW_RESTORED)
        .value("WINDOWMOUSEENTER", SDL_EVENT_WINDOW_MOUSE_ENTER)
        .value("WINDOWMOUSELEAVE", SDL_EVENT_WINDOW_MOUSE_LEAVE)
        .value("WINDOWFOCUSGAINED", SDL_EVENT_WINDOW_FOCUS_GAINED)
        .value("WINDOWFOCUSLOST", SDL_EVENT_WINDOW_FOCUS_LOST)
        .value("WINDOWOCCLUDED", SDL_EVENT_WINDOW_OCCLUDED)
        .value("WINDOWENTERFULLSCREEN", SDL_EVENT_WINDOW_ENTER_FULLSCREEN)
        .value("WINDOWLEAVEFULLSCREEN", SDL_EVENT_WINDOW_LEAVE_FULLSCREEN)
        .value("KEYDOWN", SDL_EVENT_KEY_DOWN)
        .value("KEYUP", SDL_EVENT_KEY_UP)
        .value("TEXTEDITING", SDL_EVENT_TEXT_EDITING)
        .value("TEXTINPUT", SDL_EVENT_TEXT_INPUT)
        .value("KEYBOARD_ADDED", SDL_EVENT_KEYBOARD_ADDED)
        .value("KEYBOARD_REMOVED", SDL_EVENT_KEYBOARD_REMOVED)
        .value("MOUSEMOTION", SDL_EVENT_MOUSE_MOTION)
        .value("MOUSEBUTTONDOWN", SDL_EVENT_MOUSE_BUTTON_DOWN)
        .value("MOUSEBUTTONUP", SDL_EVENT_MOUSE_BUTTON_UP)
        .value("MOUSEWHEEL", SDL_EVENT_MOUSE_WHEEL)
        .value("MOUSEADDED", SDL_EVENT_MOUSE_ADDED)
        .value("MOUSEREMOVED", SDL_EVENT_MOUSE_REMOVED)
        .value("GAMEPADAXISMOTION", SDL_EVENT_GAMEPAD_AXIS_MOTION)
        .value("GAMEPADBUTTONDOWN", SDL_EVENT_GAMEPAD_BUTTON_DOWN)
        .value("GAMEPADBUTTONUP", SDL_EVENT_GAMEPAD_BUTTON_UP)
        .value("GAMEPADADDED", SDL_EVENT_GAMEPAD_ADDED)
        .value("GAMEPADREMOVED", SDL_EVENT_GAMEPAD_REMOVED)
        .value("GAMEPADTOUCHPADDOWN", SDL_EVENT_GAMEPAD_TOUCHPAD_DOWN)
        .value("GAMEPADTOUCHPADMOTION", SDL_EVENT_GAMEPAD_TOUCHPAD_MOTION)
        .value("GAMEPADTOUCHPADUP", SDL_EVENT_GAMEPAD_TOUCHPAD_UP)
        .value("DROPFILE", SDL_EVENT_DROP_FILE)
        .value("DROPTEXT", SDL_EVENT_DROP_TEXT)
        .value("DROPBEGIN", SDL_EVENT_DROP_BEGIN)
        .value("DROPCOMPLETE", SDL_EVENT_DROP_COMPLETE)
        .value("DROPPOSITION", SDL_EVENT_DROP_POSITION)
        .value("AUDIODEVICEADDED", SDL_EVENT_AUDIO_DEVICE_ADDED)
        .value("AUDIODEVICEREMOVED", SDL_EVENT_AUDIO_DEVICE_REMOVED)
        .value("PENPROXIMITYIN", SDL_EVENT_PEN_PROXIMITY_IN)
        .value("PENPROXIMITYOUT", SDL_EVENT_PEN_PROXIMITY_OUT)
        .value("PENDOWN", SDL_EVENT_PEN_DOWN)
        .value("PENUP", SDL_EVENT_PEN_UP)
        .value("PENBUTTONDOWN", SDL_EVENT_PEN_BUTTON_DOWN)
        .value("PENBUTTONUP", SDL_EVENT_PEN_BUTTON_UP)
        .value("PENMOTION", SDL_EVENT_PEN_MOTION)
        .value("PENAXIS", SDL_EVENT_PEN_AXIS)
        .value("CAMERAADDED", SDL_EVENT_CAMERA_DEVICE_ADDED)
        .value("CAMERAREMOVED", SDL_EVENT_CAMERA_DEVICE_REMOVED)
        .value("CAMERAAPPROVED", SDL_EVENT_CAMERA_DEVICE_APPROVED)
        .value("CAMERADENIED", SDL_EVENT_CAMERA_DEVICE_DENIED)
        .export_values();
